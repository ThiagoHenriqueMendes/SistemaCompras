...
{
    public class SolicitacaoCompraConfiguration : IEntityTypeConfiguration<SolicitaCompraAgg.SolicitacaoCompra>
    {
        public void Configure(EntityTypeBuilder<SolicitaCompraAgg.SolicitacaoCompra> builder)
        {
